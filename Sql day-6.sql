...
select * from orders;
select O.orderId, O.OrderDate, O.Quantity, C.firstname, C.lastname
from orders as O join Customers as C 
on O.CustomerID = C.CustomerID; 

select O.orderId, O.OrderDate, O.Quantity, P.ProductName
...
select c.FirstName, c.lastname, c.Phone, count(o.orderId) 
from customers as c
join orders as o
on o.CustomerID=c.CustomerID
...
SELECT o.OrderID, o.OrderDate, o.Quantity, o.TotalAmount, o.PaymentStatus, c.CustomerID, CONCAT(c.FirstName, ' ', c.LastName) AS CustomerName, c.Email, c.Country
FROM Orders o
